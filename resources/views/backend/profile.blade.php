    ...
    <div class="card-body">
        <form method="post" action="{{ url('admin/updateProfil', $data->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="input-group" style="margin-bottom: 10px;">
                    <a href="#" id="foto" data-toggle="modal" data-target="#exampleModal">
                        <img src="{{ asset('storage/foto/'.$data->profile->foto) }}" width="100px" height="100px" alt="foto" id="holder">
                    </a>
                </div>
                <div class="input-group">
                    <input id="photo" class="form-control" type="file" name="foto" value="{{ $data->profile->foto }}">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group" style="margin-bottom: 10px;">
                    <a href="#" id="foto_ktp" data-toggle="modal" data-target="#modal2">
                        <img src="{{ asset('storage/foto_ktp/'.$data->profile->ktp) }}" width="100px" height="100px" alt="foto" id="holder">
                    </a>
                </div>
                <div class="input-group">
                    <input id="photo" class="form-control" type="file" name="foto_ktp" value="{{ $data->profile->ktp }}">
                </div>
                <div id="holder" style="margin-top:15px;max-height:100px;"></div>
                @error('foto_ktp')
                <span class="text-danger">{{ $message }}</span>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="status" required value="{{ $data->profile->status }}">
                @error('status')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="tanggal_lahir" required value="{{ $data->profile->tanggal_lahir }}">
                @error('tanggal_lahir')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="tempat_lahir" required value="{{ $data->profile->tempat_lahir }}">
                @error('tempat_lahir')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
