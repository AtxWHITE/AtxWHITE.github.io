<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background: linear-gradient(180deg, #036666 0%, #579f62 100%);">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <!-- Nav Item - Alerts -->
    <li class="nav-item dropdown no-arrow mx-1">
      <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" data-toggle="tooltip" data-placement="bottom" title="Notifications" role="button">
        <i class="fas fa-bell fa-fw"></i>
        <!-- Counter - Alerts -->
        <span class="badge badge-danger badge-counter" id="countNotiv">0</span>
      </a>
      <!-- Dropdown - Alerts -->
    </li>
    ...
    <li class="nav-item dropdown no-arrow mx-1" id="messageT" data-url="">
      <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" data-toggle="tooltip" data-placement="bottom" title="Messages" role="button">
        <i class="fas fa-envelope fa-fw"></i>
        <!-- Counter - Messages -->
        <span class="badge badge-danger badge-counter" id="countMessage">0</span>
      </a>
      <!-- Dropdown - Messages -->
    ...
    <li class="nav-item dropdown no-arrow">
      ...
      <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        <a class="dropdown-item" href="#">
          <a class="dropdown-item" href="{{ url('superadmin/profile') }}/{{Auth()->user()->id}}">
