...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent position-fixed w-100">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('frontend/assets/image/logo-70.png') }}" alt="Logo" width="30" height="24"
                ...
                <div>
                    @if (Auth::check())
                        <div class="dropdown">
                            ...
                            <a>
                                <!-- //name  -->
                                <a href="#" class="text-decoration-none text-white ms-2" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="{{ asset('storage/foto/' . Auth()->user()->profile->foto) }}" alt=""
                                        class="rounded-circle" width="40" height="40" aria-expanded="false">
    ...
    <section id="hero">
        <div class="container h-100">
            ...
            <img src="{{ asset('frontend/assets/image/rafiki.png') }}" alt=""
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="{{ asset('frontend/assets/image/Physical Therapy.png') }}" alt=""
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="{{ asset('frontend/assets/image/Airport Security.png') }}" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="{{ asset('frontend/assets/image/General Massage Area.png') }}" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="{{ asset('frontend/assets/image/Spa.png') }}" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="{{ asset('frontend/assets/image/Oil Massage.png') }}" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="{{ asset('frontend/assets/image/Massage.png') }}" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="jual" role="tabpanel"
                            ...
                            <div class="input-group input-cari mb-3">
                                <button class="button-secondary dropdown-toggle" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">Tipe Pijat</button>
                                ...
                                <input type="text" class="form-control"
                                    aria-label="Text input with dropdown button" placeholder="Cari Pijet">
