            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('frontend/assets/image/pijat1.jpeg') }}" class="d-block w-100"
                            alt="...">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('frontend/assets/image/pijat2.jpeg') }}" class="d-block w-100"
                            alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>First slide label</h5>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('frontend/assets/image/pijat3.jpeg') }}" class="d-block w-100"
                            alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>First slide label</h5>
                        </div>
