...
<head>
    ...
    <title>Terpist</title>
    <!-- ======= Styles ====== -->
    <link rel="stylesheet" href="{{ asset('terapis/css/style.css') }}">
</head>
    ...
    <div class="container">
            ...
            <ul>
                <li>
                    <a href="#">
                        ...
                        <span class="title" style="font-weight: 700;">PijitIn.</span>
                    </a>
                </li>
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="search">
                    <div class="row">
                        <span>Bayu Pratama (Kab. Blitar)</span>
                    </div>
                    <div class="row">
                        <div class="rating">
